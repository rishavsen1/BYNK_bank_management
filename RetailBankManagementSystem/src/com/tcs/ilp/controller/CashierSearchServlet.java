...
@WebServlet("/CashierSearchServlet")
public class CashierSearchServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(customerInfo != null) {
			...
			RequestDispatcher rd = request.getRequestDispatcher("customer-info.jsp");
