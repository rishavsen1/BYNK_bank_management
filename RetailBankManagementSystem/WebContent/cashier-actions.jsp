...
<html>
  <head>
    ...
    <link href="./resources/cashier-actions/page2.css" rel="stylesheet" type="text/css" />
    <link
  ...
  <body>
    ...
    <a href="./CashierServlet" class="card education">
    ...
    <a href="./CashierServlet1" class="card credentialing">
      <div class="overlay"></div>
      <div class="circle">
        <svg
          width="64px"
    ...
    <a href="customer-transaction.jsp" class="card wallet">
      <div class="overlay"></div>
      <div class="circle">
        <svg
          width="78px"
