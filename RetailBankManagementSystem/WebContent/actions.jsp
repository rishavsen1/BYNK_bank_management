...
<html>
  <head>
    <title>BYNK Home</title>
    <link href="./resources/actions/page2.css" rel="stylesheet" type="text/css" />
    <link
  ...
  <body>
    ...
    <a href="./NewCustomerServlet" class="card education">
          ...
          >
            <g id="Group-8" fill="#D98A19">
              <g id="Group-7">
                <g id="Group-6">
                  <path
                    d="M0,0 L0,75.9204805 L50509.1511499,75.9204805 L0,0 Z "
                    id="Fill-1"
                  ></path>
                </g>
              </g>
            ...
            >
              <path d="M14.419998734,23.3 L55.93999114,23.3" id="Line"></path>
              <path d="M15.419998734,22.8 L55.93999114,22.8" id="Line"></path>

              <path d="M15.419998734,23.8 L55.93999114,23.8" id="Line"></path>

              <path
                d="M35.419998734,4.297619 L34.93999114,42.297619"
                id="Line"
              ></path>
              <path
                d="M34.419998734,4.297619 L34.93999114,42.297619"
                id="Line"
              ></path>
              <path
                d="M34.919998734,5.097619 L34.43999114,42.597619"
                id="Line"
              ></path>
            </g>
          </g>
    ...
    <a href="./UpdateCustomerServlet" class="card credentialing">
      <div class="overlay"></div>
      <div class="circle">
        <svg
          width="64px"
    ...
    <a href="./DeleteCustomerServlet" class="card wallet">
      <div class="overlay"></div>
      <div class="circle">
        <svg
          width="78px"
    ...
    <a href="./SearchCustomerServlet" class="card human-resources">
      <div class="overlay"></div>
      <div class="circle">
        <svg
          width="66px"
